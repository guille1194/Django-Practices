...
from .views import detail_view, index_view, nosotros_view, cursos_view, talleres_view, aplicacion_view, Registrar_Curso, Registrar_Paciente, Registrar_Horario, Registrar_Profesionista
...
urlpatterns = [
    ...
    url(r'^detail/(?P<slug>[-\w]+)/$',detail_view.as_view(), name = 'detail_view'),
    ]

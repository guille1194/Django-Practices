...
from .views import buscar_curso, buscar_paciente, buscar_profesionista, index_view, nosotros_view, cursos_view, talleres_view, aplicacion_view, Registrar_Curso, Registrar_Paciente, Registrar_Horario, Registrar_Profesionista
...
urlpatterns = [
	...
	url(r'^buscar_curso/$',buscar_curso,name = 'buscar_curso'),
	url(r'^buscar_profesionista/$',buscar_profesionista,name = 'buscar_profesionista'),
	url(r'^buscar_paciente/$',buscar_paciente,name = 'buscar_paciente'),
    ]

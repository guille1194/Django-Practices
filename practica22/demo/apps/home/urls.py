...
from .views import paginator_report, index_view, nosotros_view, cursos_view, talleres_view, aplicacion_view, Registrar_Curso, Registrar_Paciente, Registrar_Horario, Registrar_Profesionista

...
urlpatterns = [
    ...
    url(r'^Registrar_Profesionista/$', Registrar_Profesionista, name ='registrar_profesionista_view'),
	url(r'^Registrar_Paciente/$', Registrar_Paciente, name='registrar_paciente_view'),
    url(r'^Registrar_Curso/$', Registrar_Curso, name='registrar_curso_view'),
    url(r'^Registrar_Horario/$', Registrar_Horario, name='registrar_horario_view'),
